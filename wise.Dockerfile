...
RUN DA_LATEST_APP=$(curl -s https://api.github.com/repos/WISE-Developers/WISE_Builder_Component/releases/latest  | grep browser_download_url | cut -d : -f 2,3 | tr -d '"') ; wget $DA_LATEST_APP -O /tmp/WISE/wise-ubuntu2204.deb
